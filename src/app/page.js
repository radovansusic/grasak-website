...
const VB = ({s=24}) => <svg width={s} height={s} viewBox="0 0 24 24" fill="currentColor"><path d="M12.2 1C10.5.9 7 1.3 5.2 3c-1.3 1.3-1.8 3.1-1.9 5.5-.1 2.4-.1 7.7 4.2 8.9v2.2s0 .9.6 1.1c.7.2 1.1-.5 1.8-1.2.4-.4.8-.9 1.2-1.3 3.4.3 6-.4 6.3-.5.7-.2 4.5-.7 5.2-5.8.6-5.2-.3-8.6-2.1-10.1-1-.9-3.2-1.6-5.3-1.7l-.1-.1zM22 16c-.5 4.2-3.5 4.5-4.1 4.6-.2.1-2.4.7-5.2.4l-2.6 3.1c-.5.6-.9.7-1.2.6-.4-.1-.4-.8-.4-.8v-3.5C4.7 19.5 5 15.5 5.1 13.5c.1-2.1.5-3.5 1.6-4.6C8.4 7.4 11.2 7 12.5 7c1.8.1 3.6.7 4.4 1.3 1.4 1.2 2.3 3.7 1.7 8.2zM14 9.3a3.6 3.6 0 012.1.9c.6.6 1 1.3 1.1 2 0 .2-.1.3-.3.3s-.3-.1-.3-.3a3 3 0 00-.8-1.5c-.5-.4-1-.7-1.6-.7-.2 0-.3-.1-.3-.3s.1-.4.1-.4zM16.3 13c0 .2-.1.3-.3.3s-.3-.2-.3-.3c0-.9-.7-1.9-1.9-2-.2 0-.3-.2-.3-.3 0-.2.2-.3.3-.3 1.5.1 2.5 1.4 2.5 2.6zM15.5 15l-.7-.3c-.2-.1-.4-.2-.5-.1l-.4.3c-.1.1-.3.1-.4 0a5.5 5.5 0 01-1.4-1.1c-.1-.2-.1-.3 0-.5l.3-.4c.1-.1.1-.3 0-.5l-.5-.7c-.2-.3-.5-.3-.7-.2-.4.2-.7.6-.7 1 0 .5.3 1.1.7 1.7.6.7 1.3 1.4 2.1 1.8.5.2.9.2 1.2 0s.6-.6.6-.9c0-.3-.2-.5-.5-.6z"/></svg>;
